  ...
  const work_data = [
    {
      ...
      description: ["Web Application Developer (Full-Time)",
        "1. Enhanced multiple Ad serving Strategies",
        "2. Developed Scripts for automating tasks, new clustering Algorithms for data analysis, Advanced SQL queries",
        "3. Data Visualization on Web App in Django and ASP.net"],
